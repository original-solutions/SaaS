  ...
  <div>
    <div class="flex items-center justify-between mb-6">
      ...
      <BaseButton v-if="tenantStore.canWrite" as-child variant="primary">
        <router-link to="/customers/create" class="inline-flex items-center gap-2">
          <Plus class="h-4 w-4" />
          Add Customer
        </router-link>
      </BaseButton>
    ...
    <div v-if="showSaveView" class="mb-4 p-4 bg-white rounded-lg border border-gray-200 shadow-sm">
      <form class="flex items-end gap-3" @submit.prevent="saveView">
        ...
        <BaseButton variant="ghost" size="sm" @click="cancelSaveView"> Cancel </BaseButton>
      </form>
    </div>
    ...
    <div class="flex items-center gap-3 mb-4">
      ...
      <BaseSelect
        ...
        class="w-[160px]"
        @update:model-value="fetchCustomers(1)"
      />
