<template>
  <div>
    <div class="flex items-center justify-between mb-6">
      ...
      <BaseButton v-if="tenantStore.canWrite" as-child variant="primary">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
      ...
      <div v-else-if="imports.length === 0" class="p-6 text-center text-sm text-gray-500">
        No imports yet.
      </div>
          ...
          <tr v-for="imp in imports" :key="imp.id" class="hover:bg-gray-50">
            ...
            <td class="px-6 py-4 text-sm text-gray-500">
              <template v-if="imp.total_rows">
                ...
                <span v-if="imp.failed_rows" class="text-red-500"
