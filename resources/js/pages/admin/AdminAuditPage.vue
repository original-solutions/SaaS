  ...
  <div>
    ...
    <div class="flex flex-wrap gap-3 mb-4">
      ...
      <BaseSelect
        ...
        class="w-[160px]"
        trigger-class="border-gray-600 bg-gray-800 text-sm text-white focus:border-indigo-500"
      ...
      <table class="min-w-full divide-y divide-gray-700">
        ...
        <tbody class="divide-y divide-gray-700">
          ...
          <tr v-for="log in logs" :key="log.id" class="hover:bg-gray-700/50">
            ...
            <td class="px-6 py-4">
              <span class="text-xs px-2 py-0.5 rounded-full" :class="eventClass(log.event)">{{
                log.event
              }}</span>
            </td>
