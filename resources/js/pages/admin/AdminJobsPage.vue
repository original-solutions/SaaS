<template>
  <div>
    ...
    <div class="flex items-center justify-between mb-4">
      ...
      <BaseButton v-if="failedJobs.length > 0" variant="primary" size="sm" @click="retryAll">
        Retry All
      </BaseButton>
    </div>
      ...
      <table class="min-w-full divide-y divide-gray-700">
        ...
        <tbody class="divide-y divide-gray-700">
          ...
          <tr v-else-if="failedJobs.length === 0">
            <td colspan="5" class="px-6 py-8 text-center text-sm text-gray-400">No failed jobs.</td>
          </tr>
          <tr v-for="j in failedJobs" :key="j.id" class="hover:bg-gray-700/50">
            ...
            <td class="px-6 py-4 text-sm text-red-400 truncate max-w-xs" :title="j.exception">
